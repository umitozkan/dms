        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Dublaj yönetim sisteminize yeni bir ortak şirket ekleyin</p>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('companies.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="radio" name="source" value="merzigo" {{ old('source', 'merzigo') == 'merzigo' ? 'checked' : '' }} required
                            ...
                            <label class="flex items-center">
                                <input type="radio" name="source" value="solar" {{ old('source') == 'solar' ? 'checked' : '' }} required
                                    class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 focus:ring-2">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="address" id="address" rows="3"
                            ...
                            placeholder="{{ __('Şirket adresini girin') }}">{{ old('address') }}</textarea>
                        @error('address')
                            <p class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
