        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">{{ __('Yapım bilgilerini güncelleyin') }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="p-8">
                <form action="{{ route('shows.update', $show) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="company_id" id="company_id" required
                            ...
                            @foreach($companies as $company)
                                <option value="{{ $company->id }}" {{ old('company_id', $show->company_id) == $company->id ? 'selected' : '' }}>
                                    {{ $company->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="channelId" id="channelId" value="{{ old('channelId', $show->channelId) }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-gray-900 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="radio" name="type" value="series" {{ old('type', $show->type) == 'series' ? 'checked' : '' }} required
                            ...
                            <label class="flex items-center">
                                <input type="radio" name="type" value="movie" {{ old('type', $show->type) == 'movie' ? 'checked' : '' }} required
                                    class="w-4 h-4 text-green-600 border-gray-300 focus:ring-green-500 focus:ring-2">
                                <span class="ml-3 text-gray-700 font-medium">{{ __('Film') }}</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="type" value="documentary" {{ old('type', $show->type) == 'documentary' ? 'checked' : '' }} required
                                    class="w-4 h-4 text-green-600 border-gray-300 focus:ring-green-500 focus:ring-2">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="total_episode" id="total_episode" value="{{ old('total_episode', $show->total_episode) }}" required min="1"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-gray-900 placeholder-gray-400"
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="total_duration" id="total_duration" value="{{ old('total_duration', $show->total_duration) }}" min="1"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-gray-900 placeholder-gray-400"
